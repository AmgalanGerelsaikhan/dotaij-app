...
/* harmony import */ var next_dist_server_web_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(384);
        ...
        var mod = __webpack_require__(654)
...
function middleware(request) {
    const shouldHandleLocale = !PUBLIC_FILE.test(request.nextUrl.pathname) && !request.nextUrl.pathname.includes("/api/") && !request.nextUrl.pathname.includes("/uk") && !request.nextUrl.pathname.includes("/en") && request.nextUrl.locale === "default";
