...
export default function BookDetail() {
  ...
  return (
    <>
      {book && (
        <>
          <div className="text-[#14213d] py-10 flex flex-col sm:flex-row">
          ...
          <div className=" mx-10 sm:mx-0">
            <p className="text-[#14213d] text-justify uppercase mb-4">{t('book.desc')}</p>
            <p className="text-[#14213d] text-justify leading-8">
              {i18n.language === 'uk' ? book.descUk : book.desc}
            </p>
          </div>

          <h1 className="text-2xl text-[#14213d] my-5">{t('book.gallery')}</h1>
